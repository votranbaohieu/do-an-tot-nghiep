...
DATA_TRAIN_PATH = os.path.join(DIR_PATH, 'data/data_train.xlsx')
DATA_TEST_PATH = os.path.join(DIR_PATH, 'data/data_test.xlsx')

DATA_TRAIN_JSON = os.path.join(DIR_PATH, 'data/data_train.json')
DATA_TEST_JSON = os.path.join(DIR_PATH, 'data/data_test.json')
